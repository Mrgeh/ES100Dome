...
import com.es100.util.FastOutSlowInInterpolator;

import static com.example.es100dome.widget.ExpandableLayout.State.COLLAPSED;
import static com.example.es100dome.widget.ExpandableLayout.State.COLLAPSING;
import static com.example.es100dome.widget.ExpandableLayout.State.EXPANDED;
import static com.example.es100dome.widget.ExpandableLayout.State.EXPANDING;
...
public class ExpandableLayout extends FrameLayout {
    ...
    public ExpandableLayout(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, com.es100.R.styleable.ExpandableLayout);
            duration = a.getInt(com.es100.R.styleable.ExpandableLayout_el_duration, DEFAULT_DURATION);
            expansion = a.getBoolean(com.es100.R.styleable.ExpandableLayout_el_expanded, false) ? 1 : 0;
            orientation = a.getInt(com.es100.R.styleable.ExpandableLayout_android_orientation, VERTICAL);
            parallax = a.getFloat(com.es100.R.styleable.ExpandableLayout_el_parallax, 1);
            a.recycle();
